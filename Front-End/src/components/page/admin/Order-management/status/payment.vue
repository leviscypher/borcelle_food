    ...
    <div class="modal-dialog">
      <div class="modal-content w-[380px] h-auto mx-auto">
        <div class="bg-white mx-auto rounded-lg py-[20px]">
          ...
          <p class="text-2xl mt-6 ml-10">xác nhận đơn hàng và vận chuyển?</p>
  ...
  >
    <div class="modal-dialog">
      <div class="modal-content w-[680px]">
        <div class="bg-white rounded-lg py-[20px] h-[480px] overflow-y-scroll " v-if="!isLoading">
          <div class="flex items-center">
            <h1 class="mb-0 ml-14">chi tiết đơn hàng</h1>
          </div>
          <div class="w-full my-[40px] flex items-center flex-col">
            <div class="w-[90%] h-[140px] border rounded-lg p-4 flex gap-[20px] mb-[10px]" v-for="item in detail" :key="item.id">
        ...
        <div class="h-[480px] flex items-center justify-center" v-if="isLoading">
          <base-load></base-load>
        </div>
