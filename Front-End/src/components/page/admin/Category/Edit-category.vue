                    ...
                    <div class="tile-body">
                        <form class="row">
                            <div class="form-group col-md-4">
                                ...
                                <input class="form-control" v-model="nameCategory.name"  type="text"
                                    required>
                            </div>
                        </form>
                    </div>
                    <div class="flex gap-[15px]">
                        <base-button class="btn btn-save" type="button" @click="updateCategory(getEditCategorys.id)">Lưu lại</base-button>
