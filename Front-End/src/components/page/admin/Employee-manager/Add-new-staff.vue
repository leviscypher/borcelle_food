...
onMounted(async () => {
  ...
  await Promise.all([position.fetchPosition(), account.fetchAccounts(), gender.fetchGender()])
              ...
              <div v-else>
                <div class="form-group col-md-12">
                  ...
                  >
                    <div
                      ...
                      role="alert"
                    >
                      Tạo nhân viên mới không thành công
                    </div>
                  </div>
                  <div
                    class="form-group col-md-4"
                ...
                <div class="form-group col-md-4">
                  ...
                  >
                    ...
                    >
                      <option
                        v-if="account.role_id === 1 && account.isActive === 0"
                        :value="account.id"
                      >
                        {{ account.username }}
                      </option>
