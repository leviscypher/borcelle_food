...
<template>
    <form class="row w-[576px] m-0 m-auto pt-[100px] pb-[70px] pl-[50px] pr-[50px] mt-[15px] mb-[15px] bg-white">
        <h3 class="text-center pb-10">Nhập mã bảo vệ</h3>
        <p class="pb-10 text-center text-[17px]">Vui lòng kiểm tra email của bạn để biết tin nhắn có mã của bạn</p>
        <div class="form-group">
            <label class="control-label">Nhập mã</label>
            <input class="form-control border-black text-[16px]" type="text" placeholder="Nhập mã">
      <small class="inline-block text-[red]">{{ error.errorNewPassword }}</small>
        ...
        <div class="flex gap-[50px]">
            <router-link to="/" class="w-[50%] m-0 rounded-[5px] decoration-none text-black come-back">Quay
                lại</router-link>
            <base-button class="w-[50%] m-0 rounded-[5px]">Tìm kiếm</base-button>
        </div>
    </form>
</template>
<style lang="scss">
