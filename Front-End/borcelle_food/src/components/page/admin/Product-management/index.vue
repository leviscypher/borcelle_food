  ...
  <div class="tile">
    <div class="tile-body">
      <div class="row element-button">
        ...
        <div class="col-sm-2">
          <a class="btn btn-delete btn-sm nhap-tu-file" type="button" title="Nhập"><i class='bx bx-cloud-upload'></i> Tải
            từ file</a>
        </div>
        ...
        <div class="col-sm-2">
          <a class="btn btn-delete btn-sm pdf-file" type="button" title="In"><i class='bx bxs-file-pdf'></i>Xuất PDF</a>
        </div>
        <div class="col-sm-2">
      ...
      <table class="table table-hover table-bordered" id="sampleTable">
        ...
        <tbody>
          <tr>
            ...
            <td>71309005</td>
            <td>Humberger</td>
            <td><img src="https://www.drhaile.vn/uploads/images/hoanganh/HA/VFADAV.jpg" alt="" width="100px;"></td>
            <td>40</td>
